 <?php
    ...
    if(!empty($_SESSION["user_name"])){
        ...
        if(!empty($_POST["title"]) && !empty($_POST["password"]) && !empty($_POST["comment"])){
            ...
            thread_userid,thread_pass,comment_count,good_count,last_date)
            values($1,$2,'{$datetime}',{$user_id},$3,0,0,'{$datetime}')";
...
<body>
    ...
    <!-- 入力が足りない場合の表示 -->
    <h2>入力が足りていません</h2>
    <a class="button1" href="source/thread/create_thread.php">スレッド作成画面へ</a>
