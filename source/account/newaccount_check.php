<?php
  ...
  /*入力の項目が足りるか*/
  if(!empty($_POST["user_name"]) && !empty($_POST["pass"]) && !empty($_POST["pass_check"])){
      $OK = 1;
      $user_name = $_POST["user_name"];
      $password = $_POST["pass"];
      $re_password = $_POST["pass_check"];
...
<body>
    ...
    <h2>入力が足りていません</h2>
    <a class="submitbtn" href="source/account/newaccount.php">アカウント作成画面へ</a>
